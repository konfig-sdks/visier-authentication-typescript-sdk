...
/**
 * This class provides a wrapper for network errors when making requests to Visier Authentication APIs
 */
export class VisierAuthenticationError extends Error {
  /**
   * The response body
   */
  ...
  constructor(axiosError: AxiosError, responseBody: unknown) {
    ...
    this.name = "VisierAuthenticationError";
